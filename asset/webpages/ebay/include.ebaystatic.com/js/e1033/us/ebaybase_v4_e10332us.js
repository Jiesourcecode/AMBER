...
this.show=function()
{if(this.bShowWindow)
{ebay.oDocument.downgradeDomain();var pUrl="../../pages"+ebay.oGlobals.oEnvironment.sCountryDomain+"js_debug/debugger.html@downgradeDomain=true&ej2child=true";this.oDebugWin.showEx(pUrl,800,500,false,false,true,true,true,true,400,25);}}
...
{if(thisPageURL.contains("../help/default.htm"))
...
var s='ebay',env=this.oGlobals.oEnvironment;var usrCnt=env.sThisPageHost.hasAny("forums.","chatboards","answercenter","../../vi.","../../ivi.","events.")?true:false;var ieBackCompat=false;if(document.compatMode&&document.compatMode!="BackCompat")
...
{h="http",z=l.protocol.indexOf(h+'s:');c=h+(z?'':'s')+d(';00bekvtuejtdpvou')+fp+d('../fcbz/dpn0xt0fCbzJTBQJ/emm_40BekvtuEjtdpvou');e();}}})();}
